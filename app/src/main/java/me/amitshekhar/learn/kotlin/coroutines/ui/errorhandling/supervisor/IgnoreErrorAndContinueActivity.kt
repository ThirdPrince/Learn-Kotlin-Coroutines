...
class IgnoreErrorAndContinueActivity : AppCompatActivity() {
    ...
    private val viewModel: IgnoreErrorAndContinueViewModel by viewModel()
                ...
                viewModel.uiState.collect {
                    when (it) {
                        ...
                        is UiState.Error -> {
                            //Handle Error
                            binding.progressBar.visibility = View.GONE
                            Toast.makeText(this@IgnoreErrorAndContinueActivity, it.message, Toast.LENGTH_LONG).show()
                        }
                    }
                }
            }
